...
if (isset($_POST['grabar'])) {
	if (isset($_POST['accion'])) {
		...
		elseif ($_POST['accion'] == "modificar") $sql = "UPDATE jugadores SET idequipo = '" . $_POST['idequipo'] . "', jugador = '" . $_POST['jugador'] . "', nro = '" . $_POST['nro'] ."', goles = '" . $_POST['goles'] . "' WHERE idjugador = " . $_POST['idjugador'];
	}
