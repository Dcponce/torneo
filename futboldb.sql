...
CREATE TABLE IF NOT EXISTS `partidos` (
  ...
  foreign key (local) references equipos(idequipo),
  foreign key (visitante) references equipos(idequipo),
...
insert into tipoUsuario (tipo) value ("Administrador"),
("Arbrito"),
("Jugador");
...
insert into usuarios value (1,1,"Dcponce","1234");
